...
function formatCompat(compatData,targetLocation,name){
	...
	create("span",false," based on " + compatData.shared + " shared entries. Lower is better. 0.8 - 1.1 is common\nFormally, this is 'standard deviation between normalized ratings'",targetLocation);
...
const commonUnfinishedManga = m4_include(data/commonUnfinishedManga.json)//eslint-disable-line no-use-before-define
